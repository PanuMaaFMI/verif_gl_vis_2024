set terminal png
set output "fc_00000000_00000000_ALL_18_VI_0_thresholds.1.png"
set datafile missing "-99"
set title "Frequency  for Visibility (m)\n   Selection: ALL    514 stations\n  Period: 20220310-20220320\n  Used {18} + 00 03 ... 48" 
...
set logscale x
 ...
 plot 'c_00000000_00000000_ALL_18_VI_0_REF.scores2' using 2:13 title 'OBS' with linespoints lt 5 lw 2 pt 7,'c_00000000_00000000_ALL_18_VI_0_REF.scores2' using 2:14 title 'REF' with linespoints lt 1 lw 2 pt 7,'c_00000000_00000000_ALL_18_VI_0_REF_RED.scores2' using 2:14 title 'REF_RED' with linespoints lt 2 lw 2 pt 7,'c_00000000_00000000_ALL_18_VI_0_FULLPOS.scores2' using 2:14 title 'FULLPOS' with linespoints lt 3 lw 2 pt 7,'c_00000000_00000000_ALL_18_VI_0_GULTEPE.scores2' using 2:14 title 'GULTEPE' with linespoints lt 4 lw 2 pt 7